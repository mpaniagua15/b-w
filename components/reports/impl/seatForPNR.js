...
class SeatForPNRReport extends Report {
    ...
    _reportQuery(tmpTable){
		...
		from
        	${tmpTable} t
        	left join wiki_resumida_para_asientos w1 on (t.PNR = w1.transaction_code_producto)
			left join wiki_resumida_para_asientos w2 on (t.PNR = w2.TRANSACTION_CODE)
...
module.exports = SeatForPNRReport;
