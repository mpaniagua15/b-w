...
class EmisionsReport extends Report {
    ...
    _tableDefinition(){
        return `(
            ...
            RC VARCHAR(20),
            Comision_sin_IVA VARCHAR(40),
            Fee_Mark_Up_sin_IVA VARCHAR(40),
